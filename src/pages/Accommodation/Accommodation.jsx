    ...
    <section className="accommodation__header">
        ...
        <div className="accommodation__host-and-rating">
          <div className="accommodation__host">
            ...
            <img className="accommodation__host-picture" src={logement.host.picture} alt={logement.host.name} />
          </div>
          ...
          <div>
            {[1, 2, 3, 4, 5].map((star) => (
              <img
                ...
                alt={star <= parseInt(logement.rating) ? "Étoile active" : "Étoile inactive"}
